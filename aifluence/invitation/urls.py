...
from .views import invitation_create, invitation_influencer, invitation_accepted, invitation_rejected, influencer_invitations
...
urlpatterns = [
    ...
    path('', influencer_invitations, name='influencer_invitations'),
]